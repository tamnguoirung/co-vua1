...
def main():
    ...
    screen.fill(p.Color("white")) #để board full trắngtrắng
    ...
    animate = False  # flag variable thực hiện hiệu ứng di chuyển khi nào
    loadImages()  # 
    running = True
    square_selected = ()
    player_clicks = []
    ...
    while running:
        ...
        if game_state.checkmate:
            ...
            if game_state.white_to_move:
                drawEndGameText(screen, "Chiếu hết, đen thắng")
            else:
                drawEndGameText(screen, "Chiếu hết, trắng thắng")
