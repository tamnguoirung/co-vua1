...
class GameState:
    ...
    def makeMove(self, move):
        ...
        self.move_log.append(move) #luu nuoc di
        ...
        if move.piece_moved[1] == "p" and abs(move.start_row - move.end_row) == 2: #tot di chuyenchuyen
            self.enpassant_possible = ((move.start_row + move.end_row) // 2, move.start_col) #xoa quan tot bi batbat
        else:
            self.enpassant_possible = ()
    ...
    def getValidMoves(self):#khong lap lailai
        ...
        if self.in_check:
            if len(self.checks) == 1: #NUOC DI VUA CHIEU
            ...
            for i in range(1, 8):
                ...
                if 0 <= end_row <= 7 and 0 <= end_col <= 7:
                    ...
                    if end_piece[0] == ally_color and end_piece[1] != "K":
                        ...
                        # 5 khả năng trong câu điều kiện phức tạp này
                        # 1.) trực giao với quân vua và quân là quân xe
                        #2.) theo đường chéo của vua và quân là quân tượng
                        #3.) Vua và quân cách chéo 1 ô vuông là Tốt
                        #4.) hướng nào quân nào cũng là quân hậu
                        #5.) hướng nào cũng cách 1 ô và quân là vua
